// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 07.09.2013 2:20:47
...
public class websdrsound extends java.applet.Applet
    implements javax.sound.sampled.LineListener, java.lang.Runnable, java.awt.event.MouseListener {
    ...
    public void paint(java.awt.Graphics g) {
        ...
        g.drawString("Java version: " + java.lang.System.getProperty("java.version"), 10, 88);
        if(OOOOO) {
            return;
        } else {
    ...
    public void O(java.awt.event.MouseEvent mouseevent) {
    }
    ...
    public void setparam(java.lang.String s) {
    ...
    public void start() {
        javax.sound.sampled.AudioFormat audioformat = new AudioFormat(48000F, 16, 1, true, false);
        ...
        try {
            O = (javax.sound.sampled.SourceDataLine)javax.sound.sampled.AudioSystem.getLine(info);
            O.open(audioformat, 0x17700);
        }
        catch(javax.sound.sampled.LineUnavailableException lineunavailableexception) {
            java.lang.System.out.print("sound -> error opening sound system: " + lineunavailableexception + "\n");
        }
        ...
        try {
            ...
            java.lang.System.out.print("sound -> error opening TCP connection: " + exception + "\n");
            O0O = -3;
            O();
        }
        O0O = 4;
        ...
        OO00.start();
        netscape.javascript.JSObject.getWindow(this).eval("soundappletstarted()");
        addMouseListener(this);
        O();
        O0OO0 = java.lang.System.currentTimeMillis();
    }
    ...
    void OO(int i) {
        ...
        OOO0O0O[0] = OOO0O0O[1];
        OOO0O0O[1] = OOO0O0O[2];
        OOO0O0O[2] = (float)O.getFramePosition() / 48F - (float)(java.lang.System.currentTimeMillis() - O0OO0);
        ...
        for(int l1 = 0; l1 < i; l1++) {
            for(int j1 = 0; j1 < 6; j1++) {
                int l = {
                    ...
                    0.0080115F, 1.7366E-005F, -0.010139F, -0.020236F, -0.027388F, -0.028593F, -0.02145F, -0.0048089F, 0.020752F, 0.052804F, 
                    0.087352F, 0.11948F, 0.14428F, 0.15778F, 0.15778F, 0.14428F, 0.11948F, 0.087352F, 0.052804F, 0.020752F, 
                    -0.0048089F, -0.02145F, -0.028593F, -0.027388F, -0.020236F, -0.010139F, 1.7366E-005F, 0.0080115F, 0.01262F, 0.01366F, 
        ...
        OOO0OOO[1] = OOO0OOO[2];
        OOO0OOO[2] = OOO0OOO[3];
        OOO0OOO[3] = (float)OOOO00O / 48F - (float)(java.lang.System.currentTimeMillis() - O0OO0);
    ...
    public void run() {
        ...
        try {
            do {
                if(java.lang.Thread.currentThread() != OO00)
                    break;
                O0O++;
                O();
                l3 = 0;
    ...
    public static void O(java.lang.String as[]) {
        java.lang.System.out.println("Copyright 2007-2013, Pieter-Tjerk de Boer, PA3FWM, pa3fwm@websdr.org - All rights reserved.");
        java.lang.System.out.println("Since the intended use of this (or any) applet involves sending a copy to the client computer, I (PA3FWM) hereby allow making it available unmodified, as part of the original .jar file, via my original WebSDR server software, to original WebSDR clients.");
        java.lang.System.out.println("I do not permit reverse engineering of this applet; please contact me for the motivation for that.");
    }

    private javax.sound.sampled.SourceDataLine O;
    private java.net.Socket OO;
    private java.io.InputStream O0;
    java.io.OutputStream OOO;
    ...
    int O00O;
    java.lang.String OOO0;
    int O0O0;
    java.lang.Thread OO00;
    boolean O000;
    boolean OOOOO;
    boolean O0OOO;
    public int smeter;
