...
{
   document.getElementById(w.div).innerHTML='<hr><span id="debug3"></span><br><div>'+
      '<applet code="websdrwaterfall.class" align=top archive="websdr-1360526382.jar" width=1024 height='+waterheight+' name="waterfallapplet'+w.id+'" MAYSCRIPT>' +
...
/*
   w['setslow']=function (slow) { wfa.setslow(slow); }
*/
