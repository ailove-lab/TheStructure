...
class Dharma
    ...
    # convert p{x,y} from cartesian to baricentric coordinate system
    c2b: (p, a, b, c)->
    ...
    onMouseMove: (e)=>
        ...
        cid = 0
        for h, t of triangles
            @lineTriangles.add @createLineTriangle t[0], t[1], t[2], 1.0, cid = ++cid % colors.length
    ...
    createFaceTriangle: (a, b, c, z=0.0, cid=0)->
        ...
        new THREE.Mesh( geom, new THREE.MeshBasicMaterial( { color: colors[cid], opacity: 0.75} ) );
