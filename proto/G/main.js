...
Dharma = (function() {
  ...
  Dharma.prototype.onMouseDown = function(e) {
    var a, b, c, h, m, o, t, triangles, x0, y0, z, _results;
    ...
    for (h in triangles) {
      t = triangles[h];
      if (!this.faces[h]) {
        _results.push(this.faceTriangles.add(this.faces[h] = this.createFaceTriangle(t[0], t[1], t[2], z += 0.01)));
      } else {
  ...
  Dharma.prototype.onMouseMove = function(e) {
    ...
    for (h in triangles) {
      t = triangles[h];
      _results.push(this.lineTriangles.add(this.createLineTriangle(t[0], t[1], t[2], 1.0, cid = ++cid % colors.length)));
    }
    return _results;
  };
